...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  $button_menu.addEventListener('click', function () {
    ...
    var _iterator = _createForOfIteratorHelper($txt_button),
        _step;
  ...
  var $champ_mdp = document.getElementById('champ_mdp'); // Fonction d'évenement au client du bouton de gen

  $button_genere_mdp.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var responseHTTP, reponseJSON;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('https://api.motdepasse.xyz/create/?include_digits&include_lowercase&password_length=32&quantity=1');

          case 2:
            responseHTTP = _context.sent;
            _context.next = 5;
